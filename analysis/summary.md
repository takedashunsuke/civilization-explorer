...
| 実行回 | LLM | 生存 | 保持率 | 1 世界だけ生存（初期名簿） | 読み |
|--------|-----|------|--------|----------------------------|------|
| [run3-001](./output/run3-001/summary.md) | stub | 278 / 159 / 236 / 127 | **0.056** / 0.032 / 0.047 / 0.025 | **2** | 共和が最多。争い・共同は 0 |
| [run3-002](./output/run3-002/summary.md) | 1b 観測＋サンプル | 190 / 182 / 189 / 93 | 0.038 / 0.036 / 0.038 / 0.019 | 4 | stub と 014 の間 |
| [run3-003](./output/run3-003/summary.md) | 観測 1b・決定 8B | **10 / 10 / 10 / 10** | **0.002**（4 世界とも） | **15** | 共同 318–372。社会差は消えた。初期名簿の 2 世界生存は 0 |
