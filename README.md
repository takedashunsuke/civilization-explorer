...
- 初期条件（年・舞台・大陸/島・気候・列あたり人口 100〜1000・制度・税率・教育）からシミュレーションを作成できる。西暦 3000 年まで
- Tick（+10年 / +50年）でエージェントが動き、集団領域・争い・出来事が平面世界地図に出る。大きな衝撃は見出しと「世界の便り」
- 地図下で五指標を地域比較できる（表・バー・レーダー）
